...
- (void)viewWillAppear:(BOOL)animated {
	...
	UITextView *heading = [UnsocialAppDelegate createTextViewControl:caltitle frame:CGRectMake(15, -2, 290, 40)  txtcolor:[UIColor orangeColor] backgroundcolor:[UIColor clearColor] fontwithname:kAppFontName fontsize:kTextFieldFont returnKeyType:UIReturnKeyDefault keyboardType:UIKeyboardTypeDefault scrollEnabled:NO editable:NO];
	heading.contentInset = UIEdgeInsetsMake(0, -8, 0, 0);
...
-(void)btnSave_Click{
	...
	[dateFormatfrom setDateFormat:@"E~EEE dd yyyy hh:mm a"];
	...
	[dateFormatto setDateFormat:@"E~EEE dd yyyy hh:mm a"];
...
- (void)createControls {
	...
	UILabel *lblTo = [UnsocialAppDelegate createLabelControl:[@"To- " stringByAppendingString:calto] frame:CGRectMake(120, 63, 260, 20) txtAlignment:UITextAlignmentLeft numberoflines:1 linebreakmode:UILineBreakModeWordWrap fontwithname:kAppFontName fontsize:klabelFontSize txtcolor:[UIColor whiteColor] backgroundcolor:[UIColor clearColor]];
	...
	UITextView *featuredesc = [UnsocialAppDelegate createTextViewControl:caldesc frame:CGRectMake(15, 95, 290, 260)  txtcolor:[UIColor whiteColor] backgroundcolor:[UIColor clearColor] fontwithname:kAppFontName fontsize:kTextFieldFont returnKeyType:UIReturnKeyDefault keyboardType:UIKeyboardTypeDefault scrollEnabled:NO editable:NO];
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
	...
	if(([txtUsername.text compare:@""] == NSOrderedSame)){
		...
		UIAlertView *showAlert = [[UIAlertView alloc]initWithTitle:nil message:@"Please fill the requried fields" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
		[showAlert show];
		[showAlert release];
		return NO;
	}
		...
		if(loginchk)
		{
			UIAlertView *showAlert = [[UIAlertView alloc]initWithTitle:nil message:@"Your credentials has been sent to you by email." delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
			[showAlert show];
			[showAlert release];
			//[txtUsername becomeFirstResponder];
			txtUsername.text = @"";			
...
- (BOOL) sendRequest4ForgotPwd: (NSString *) flag {
	...
	NSString *urlString = [globalUrlString stringByAppendingString:@"/iphone/iPhoneReqPage.aspx"];	
	...
	for (id key in dic)
	{
		...
		if ([key compare:@"Mailsent"] == NSOrderedSame)			
		{
			if ([[dic objectForKey:key] compare:@""] != NSOrderedSame)
			{
				...
				successflg=YES;
				//UIAlertView *showAlert = [[UIAlertView alloc]initWithTitle:@"your credentials has been sent to you by email" message:nil delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
				//[showAlert show];
				//[showAlert release];
				break;
			}
