...
@implementation EventDatePicker
...
-(void)createPicker
{
	...
	myPickerView.minimumDate = [NSDate date];
...
- (void)changeDateInLabel:(id)sender{
	...
	[arrayAddDateEvent addObject:[NSString stringWithFormat:@"%@", [df stringFromDate:myPickerView.date]]];
	[df release];
}
