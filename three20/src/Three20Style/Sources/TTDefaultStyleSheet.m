...
- (TTStyle*)pageDot:(UIControlState)state {
  if (state == UIControlStateSelected) {
    return [self pageDotWithColor:[UIColor whiteColor]];
	  ...
	  // commented by pradeep on 14 Jan 2011 for changing page controle color frm gray to orange
	  return [self pageDotWithColor:[UIColor orangeColor]]; //RGBCOLOR(77, 77, 77)];
  }
}
